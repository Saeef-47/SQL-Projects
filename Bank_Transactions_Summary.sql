...
SELECT 
    "AccountNumber",
    "AccountHolderName",
    SUM(CASE WHEN "TransactionType" = 'Deposit' THEN "TransactionAmount" ELSE 0 END) AS TotalDeposits,
    SUM(CASE WHEN "TransactionType" = 'Withdrawal' THEN "TransactionAmount" ELSE 0 END) AS TotalWithdrawals,
